...
import com.rooms.android.readbook.model.WordInfo;
...
public class GetWordTextView extends AppCompatTextView {
    ...
    private void dealEnglish() {
        List<WordInfo> wordInfoList = WordTextUtil.getEnglishWordIndices(mText.toString());
