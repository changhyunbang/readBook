package com.rooms.android.readbook.curl;
...
public class CurlView extends GLSurfaceView implements View.OnTouchListener, CurlRenderer.Observer {
        ...
        final String TAG = CurlView.class.getSimpleName();
	...
	public CurlView(Context ctx, AttributeSet attrs, int defStyle) {
        ...
        public int getCurrentPage() {
            ...
            Log.d(TAG, "getCurrentPage : " + mCurrentPage);
            return mCurrentPage;
        }
                ...
                case MotionEvent.ACTION_UP: {
                    ...
                    if (mCurlState == CURL_LEFT || mCurlState == CURL_RIGHT) {
                        ...
                        if (mPageChangedObserver != null) {
                            mPageChangedObserver.onPageChanged(mCurrentPage);
                        }

//                        Log.d(TAG, "Touch up mCurrentPage : " + mCurrentPage);
                    }
                    break;
                }
            }
        ...
        public void setCurrentIndex(int index) {
            ...
            Log.d(TAG, "mAllowLastPageCurl : " + mAllowLastPageCurl);
            Log.d(TAG, "mPageProvider.getPageCount() : " + mPageProvider.getPageCount());
...
//            Log.d(TAG, "startCurl mCurrentIndex : " + mCurrentIndex);
        }
